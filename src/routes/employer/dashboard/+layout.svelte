<script>
	...
	let activeNavItem = $derived(page.url.pathname);
	let sidebarOpen = $state(true);

	const navItems = [
		{ name: 'Dashboard', href: '/employer/dashboard', icon: LayoutDashboard },
		{ name: 'Applications', href: '/employer/dashboard/applications', icon: FileText },
		{ name: 'Company Profile', href: '/employer/dashboard/profile', icon: CircleUser }
	];
	...
	const publicNavItems = [
		{ name: 'Home', href: '/employer/dashboard/home' },
		{ name: 'About', href: '/employer/dashboard/about' },
		{ name: 'Contact', href: '/employer/dashboard/contact' }
	];
</script>
...
<div
	class="transition-al mt-24 min-h-screen bg-gray-100 p-3 duration-300 ease-in-out"
